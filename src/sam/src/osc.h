...
#define OSC_BLOB void*      ///< An OSC blob type
  ...
  static const char SLIP_END = (const char)192;                    ///< Signals the end of a SLIP-encoded sequence
  static const char SLIP_ESC = (const char)219;                    ///< SLIP escape character
  static const char SLIP_ESC_END[2] = {SLIP_ESC, (const char)220}; ///< the escaped SLIP end character
  static const char SLIP_ESC_ESC[2] = {SLIP_ESC, (const char)221}; ///< the escaped SLIP escape character
