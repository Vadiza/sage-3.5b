...
typedef enum dot_position { TOP, BOTTOM, LEFT, RIGHT };
...
typedef struct ir_t {
  ...
  int yDist;
  double distAr;
  enum dot_position xId;
  enum dot_position yId;
  enum dot_position lastXid;
  enum dot_position lastYid;
