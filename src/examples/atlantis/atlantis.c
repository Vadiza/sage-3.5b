...
{
  frameNum++;
  if (frameNum % 10 == 0) {  // update every 10th frame
    char l[256];
...
void CheckSageMessages(int value)
{
  processMessages(sageInf,NULL,NULL,NULL);

  glutTimerFunc(50, CheckSageMessages, 0);
}
...
void removeMenu(int eventId, button * btnObj)
{
...
void quit(int eventId, button * btnObj)
{
  deleteSAIL(sageInf);
...
main(int argc, char **argv)
{
  ...
  sageInf = createSAIL("atlantis", resX, resY, PIXFMT_888, NULL);
